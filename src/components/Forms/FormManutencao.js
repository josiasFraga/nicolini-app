...
import {SocialIcon, Button, Icon, ListItem} from 'react-native-elements';
...
type Props = {};
class FormManutencao extends Component<Props> {
  state = {
    imagem: '',
    modalVisible: false,
    choosingImage: false,
          ...
          <View>
            ...
            <View style={GlobalStyle.row}>
              ...
              <View
                ...
                {typeof this.props.viagem.Veiculo !== 'undefined' &&  (
                  <Text style={styles.fieldValue}>
                    {this.props.viagem.Veiculo.placa}
                  </Text>
                )}
              </View>
            </View>
            ...
            <View style={[GlobalStyle.secureMargin]}>
              ...
              <Field
                ...
                <Picker.Item label="Cartão BPP" value="cartaoBPP" />
              </Field>
            </View>
...
let InitializeFromStateForm = reduxForm({
  ...
  validate: values => {
    ...
    errors.pagamento = !values.pagamento ? 'Obrigatório' : undefined;
